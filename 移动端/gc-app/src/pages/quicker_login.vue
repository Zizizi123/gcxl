  ...
  methods: {
    ...
    //   }
      if (REG_TELPHONE.test(this.ruleForm.telphone)) {
        ...
        console.log(this.ruleForm.role);
        console.log(this.ruleForm.telphone);
        ...
        //     this.ruleForm.code = '';
        //     this.ruleForm.code2 = '';
        //     this.ruleForm.pass = 'Chen123456';
        //     this.ruleForm.checkPass = 'Chen123456';
        ...
        //   }
         if(response.status==204){
              ...
              if((this.ruleForm.role=='student')&&(response.data==3)){
                this.$toast({
                  message: '学生登陆成功',
                  iconClass: 'icon icon-success',
                  duration: 1000
                });
                // this.setStorage(this.ruleForm);
                this.$router.push('/home_student');
              }
              if((this.ruleForm.role=='teacher')&&(response.data==3)){
                this.$toast({
                  message: '教师登陆成功',
                  iconClass: 'icon icon-success',
                  duration: 1000
